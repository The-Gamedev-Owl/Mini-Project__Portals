...
public class Portal : MonoBehaviour {
    ...
    public void Render () {
        ...
        for (int i = startIndex; i < recursionLimit; i++) {
            portalCam.transform.SetPositionAndRotation (renderPositions[0], renderRotations[0]);
            //SetNearClipPlane ();
            //HandleClipping ();
            portalCam.Render ();
        ...
        //portalCam.transform.SetPositionAndRotation(renderPositions[renderPositions.Length - 1], renderRotations[renderPositions.Length - 1]);
        portalCam.Render();
        linkedPortal.screen.material.SetInt("displayMask", 1);
